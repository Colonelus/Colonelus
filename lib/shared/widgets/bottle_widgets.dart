    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) => Stack(
        ...
        children: [
          ...
          CustomPaint(
            painter: _OwnerAdminBottlePainter(progress: _controller.value),
          ),
        ],
      ),
    );
...
class _OwnerAdminBottlePainter extends CustomPainter {
  final double progress;
  const _OwnerAdminBottlePainter({this.progress = 0});
  @override
  void paint(Canvas canvas, Size size) {
    final w = size.width;
    final h = size.height;
    final bodyPath = Path()
      ..moveTo(w * 0.32, h * 0.10)
      ..quadraticBezierTo(w * 0.28, h * 0.22, w * 0.22, h * 0.36)
      ..quadraticBezierTo(w * 0.10, h * 0.62, w * 0.18, h * 0.85)
      ..quadraticBezierTo(w * 0.28, h * 0.98, w * 0.50, h * 0.98)
      ..quadraticBezierTo(w * 0.72, h * 0.98, w * 0.82, h * 0.85)
      ..quadraticBezierTo(w * 0.90, h * 0.62, w * 0.78, h * 0.36)
      ..quadraticBezierTo(w * 0.72, h * 0.22, w * 0.68, h * 0.10)
      ..quadraticBezierTo(w * 0.62, h * 0.04, w * 0.58, h * 0.02)
      ..lineTo(w * 0.42, h * 0.02)
      ..quadraticBezierTo(w * 0.38, h * 0.04, w * 0.32, h * 0.10)
      ..close();
    ...
    final aura = Paint()
      ..shader =
          RadialGradient(
            colors: [
              const Color(0xFF7DF9FF).withAlpha((120 + (40 * pulse)).round()),
              const Color(0xFF8E7CFF).withAlpha((64 + (22 * pulse)).round()),
              Colors.transparent,
            ],
          ).createShader(
            Rect.fromCircle(
              center: Offset(w * 0.5, h * 0.56),
              radius: w * (0.62 + (0.06 * pulse)),
            ),
          )
    ...
    final fill = Paint()
      ..shader = LinearGradient(
        ...
        colors: [
          const Color(0xFFE9FEFF).withAlpha(245),
          const Color(0xFF8EEBFF).withAlpha(220),
          const Color(0xFF3A6DFF).withAlpha(200),
          const Color(0xFF1B224A).withAlpha(240),
        ],
  ...
  @override
  bool shouldRepaint(covariant _OwnerAdminBottlePainter oldDelegate) =>
